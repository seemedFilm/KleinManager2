// form2.js
class Form2Manager extends KleinManagerCore {
    constructor() {
        super();
    }
    ...
    clearForm2Data() {
        ...
        this.showToast('Formular zurückgesetzt.', 'warning');
    }
...
document.addEventListener("DOMContentLoaded", () => {
    if (window.app) {
        app.form2Manager = new Form2Manager();
        app.copyMethodsFromManager(app.form2Manager);
    }
});
